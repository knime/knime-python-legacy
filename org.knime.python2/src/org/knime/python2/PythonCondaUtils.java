...
public final class PythonCondaUtils {
    ...
    public static String getPython2EnvironmentName(final Conda conda, final String suffix) throws IOException {
        return getDefaultPythonEnvironmentName(conda, PythonVersion.PYTHON2, suffix);
    }
    ...
    public static String getPython3EnvironmentName(final Conda conda, final String suffix) throws IOException {
        return getDefaultPythonEnvironmentName(conda, PythonVersion.PYTHON3, suffix);
    }

    private static String getDefaultPythonEnvironmentName(final Conda conda, final PythonVersion pythonVersion,
    ...
    public static CondaEnvironmentIdentifier createEnvironmentFromFile(final Conda conda,
        final PythonVersion pythonVersion, final String pathToFile, String environmentName,
